...
<head>
  ...
  <title>Roman's Knitting Projects</title>
...
<header>
  <h1>Roman's Knitting Projects</h1>
  <p class="tagline">Made with yarn and patience</p>
    <video autoplay muted playsinline style="display: block; width: 50%; margin-top: -10%; margin-bottom: -5%; margin-left: auto; margin-right: auto;">
      <source src="assets/walking-animation.mov" type="video/quicktime">
      <source src="assets/walking-animation.webm" type="video/webm">
    </video>
</header>
